...
def promotion():
    promotion_lines = ['Человечество вырастает из детства.', 'Человечеству мала одна планета.',
                       ...
                       'Присоединяйся!']
    return '<br><br>'.join(promotion_lines)
...
def image_mars():
    return f"""<!doctype html>
                <html lang="en">
                  ...
                  <body>
                    <h1>Жди нас, Марс!</h1>
                    <img src="{url_for('static', filename='img/mars.jpg')}" width="256" height="256">
...
def choice(planet_name):
    ...
    return """<!doctype html>
                ...
                <h3 align="left">{short_description}</h3>
                <div class="alert alert-success" role="alert">
                    <h3>{description1}</h3>
                </div>
                <div class="alert alert-secondary" role="alert">
...
def selection_results(nickname, level, rating):
    return f"""<!doctype html>
                ...
                <h2 align="left">Претендетна на участие в миссии {nickname}:</h2>
                <div class="alert alert-success" role="alert">
